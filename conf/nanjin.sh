...
export BLINK_MPI_HOME="/software/kp920-RL8/Stages/2024/software/OpenMPI/5.0.3-GCC-14.1.0" # MPI home folder
...
export BLINK_NG_CONFIGURE_FLAGS="MPICC=mpicc MPICXX=mpicxx HRT_ARCH=6 LDFLAGS=-lpthread --with-mpi=/software/kp920-RL8/Stages/2024/software/OpenMPI/5.0.3-GCC-14.1.0/"

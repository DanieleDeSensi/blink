...
export BLINK_MPI_HOME="/root/hpc/openmpi/" # MPI home folder
...
export BLINK_PINNING_FLAGS=" --allow-run-as-root --bind-to socket" # Pinning flags
...
export BLINK_NG_CONFIGURE_FLAGS="MPICC=mpicc MPICXX=mpicxx HRT_ARCH=6 LDFLAGS=-lpthread --with-mpi=/root/hpc/openmpi/"
...
export BLINK_MPIRUN_HOSTNAMES_FLAG=" -H "
export BLINK_PARTITION="nanjin"

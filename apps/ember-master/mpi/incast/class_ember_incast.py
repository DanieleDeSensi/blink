class app:
    ...
    #data parameters:
    path_to_executable='./apps/ember-master/mpi/incast/incast'
    num_metrics=3 #(int) specifies how many datapoints are collected
    data_labels=['Time','Msg-Throughput','Throughput']#(list (of length num_metrics) of strings)
    data_units=['s','Msg/s','MB/s'] #(list (of length num_metrics) of strings)

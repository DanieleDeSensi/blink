class app:
    ...
    #data parameters:
    path_to_executable='./apps/internals/bdc_nb/bdc_nb'#(string) path to executable
    num_metrics=5 #(int) specifies how many datapoints are collected
    data_labels=['Avg-Duration','Min-Duration','Max-Duration','Median-Duration','Sender-Duration']#(list (of length num_metrics) of strings)

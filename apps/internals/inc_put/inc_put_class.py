class app:
    ...
    #data parameters:
    path_to_executable='./apps/internals/inc_put/inc_put'#(string) path to executable
    num_metrics=5 #(int) specifies how many datapoints are collected
    data_labels=['Avg-Duration','Min-Duration','Max-Duration','Median-Duration','Putted-Duration']#(list (of length num_metrics) of strings)

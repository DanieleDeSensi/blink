...
def main():
    ...
    for metric_hr in args.metrics.split(","):      
        ...
        if "line" in plot_types:
            # Setup the plot
            ax = sns.lineplot(data=global_df, x="Input", y=metric_hr, hue="Extra", style="Extra", markers=True, linewidth=3, markersize=8, hue_order=labels)
            ...
            if global_df_time is not None:
                ...
                sns.lineplot(data=global_df_time, x="Input", y="Runtime (us)", hue="Extra", style="Extra", marker="o", ax=ax2)
                ax2.set_xlim([0, 5])
        ...
        if "box" in plot_types:
            ax = sns.boxplot(data=global_df, x="Input", y=metric_hr, hue="Extra")
        ...
        if "bar" in plot_types:
            ax = sns.barplot(data=global_df, x="Input", y=metric_hr, hue="Extra")
